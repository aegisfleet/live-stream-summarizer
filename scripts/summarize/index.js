...
4. 見どころは各チャンクごとに最低3以上個抽出してください。
5. 配信の種類や内容に応じて適切なタグを付与してください。
6. タイムスタンプは、動画の開始を00:00:00として、そこからの経過時間を[時間:分:秒]でコロン区切りの形式で正確に記載してください。
...
"timestamp": "HH:MM"  // 誤り（秒が省略されている）
"timestamp": "HH:MM:SS:00"  // 誤り（ミリ秒が含まれている）

正しい出力形式:
✅
"timestamp": "HH:MM:SS"  // 正しい形式
